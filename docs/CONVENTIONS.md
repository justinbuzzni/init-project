...
> 마지막 갱신: 2026-09-05
> 스타터 유지보수 명령과 소비 프로젝트 작성 영역을 구분한다. 소비 프로젝트에서 스타터 검증을 애플리케이션 테스트로 대신하지 않는다.
...
| SessionStart 빈 프로젝트 샘플 | printf '%s' '{}' &#124; CLAUDE_PROJECT_DIR=/dev/null bash .claude/hooks/session_start.sh | 종료 0, 출력 없음 |
